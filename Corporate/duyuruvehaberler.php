...
<head>
    ...
    <title><?php echo $ini['announce_and_news']; ?></title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tüm <?php if($dh=="D"){ echo " Duyurular"; } else { echo " Haberler"; }?></h1>
                        ...
                        <div class="col-xl-9 col-lg-8">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><?php if($dh=="D"){ echo " Duyurular"; } else { echo " Haberler"; }?></h6>
                                </div><?php
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="height: 250px;"
